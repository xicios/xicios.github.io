...
function randomShellName() {
	return Math.random() < 0.5 ? '芸芸众生' : shellNames[(Math.random() * (shellNames.length - 1) + 1) | 0 ];
}
...
const fastShellBlacklist = ['烟花易冷', '天女散花', '隐入尘烟'];
...
const shellTypes = {
	...
	'火树银花': crackleShell,
	'打上花火': crossetteShell,
	'芸芸众生': crysanthemumShell,
	'烟花易冷': fallingLeavesShell,
	'天女散花': floralShell,
	'绣球娶亲': ghostShell,
	'马兰花开': horsetailShell,
	'风流云散': palmShell,
